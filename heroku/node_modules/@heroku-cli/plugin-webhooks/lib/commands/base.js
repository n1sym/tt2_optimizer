...
class default_1 extends command_1.Command {
    constructor(argv, config) {
        ...
        client.defaults.headers = Object.assign({}, this.heroku.defaults.headers, { Accept: 'application/vnd.heroku+json; version=3.webhooks', authorization: `Basic ${Buffer.from(':' + this.heroku.auth).toString('base64')}` });
