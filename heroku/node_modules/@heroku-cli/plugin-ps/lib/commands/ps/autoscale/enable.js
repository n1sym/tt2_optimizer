...
class Enable extends command_1.Command {
    async run() {
        ...
        if (scaleMonitor) {
            updatedValues = Object.assign({}, updatedValues, { min_quantity: flags.min || scaleMonitor.min_quantity, max_quantity: flags.max || scaleMonitor.max_quantity, value: flags.p95 ? flags.p95 : scaleMonitor.value });
            ...
            updatedValues = Object.assign({}, updatedValues, { name: 'LATENCY_SCALE', min_quantity: flags.min, max_quantity: flags.max, value: flags.p95 ? flags.p95 : 1000 });
